...
class LoadStreams:  # multiple IP or RTSP cameras
    def __init__(self, sources='streams.txt', img_size=640, stride=32, pipeline=None):
        self.mode = 'stream'
        self.img_size = img_size
        self.stride = stride
    ...
    def update(self, index, pipeline):
        ...
        while True:
            ...
            if n == 1:  # read every 4th frame
                # success, im = self.pipeline.retrieve()
                ...
                self.imgs[index] = color
                self.depth[index] = colorized_depth
                self.align[index] = aligned_depth_frame
    ...
    def __next__(self):
        ...
        return self.sources, img, img0, None, self.depth[0], self.align[0]
